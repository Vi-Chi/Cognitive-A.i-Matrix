...
ACTION_LAYER_SIGNATURES: frozenset[str] = frozenset({
    ...
    # Vendored safety patch: sub-typed local actions must stay in Ω₈.
    "m.action", "m.actuation", "m.command",
})
ACTION_LAYER_PREFIXES: tuple[str, ...] = ("cmd.", "m.action.", "m.actuation.", "m.command.")
